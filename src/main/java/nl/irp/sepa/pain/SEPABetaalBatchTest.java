...
public class SEPABetaalBatchTest {

	@Test
	public void test() throws DatatypeConfigurationException, JAXBException, FileNotFoundException {
		SEPABetaalBatch document = new SEPABetaalBatch();
		
		document.buildGroupHeader("test-01", "Stedelijk Wonen");
		...
		FileOutputStream outputStream = new FileOutputStream("/home/jdkrijgsman/test.xml");
